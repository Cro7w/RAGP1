...
import { type Equal, type Or, type Simplify } from 'drizzle-orm/utils';
import { z } from 'zod';
...
declare type MaybeOptional<TColumn extends AnyPgColumn, TType extends z.ZodTypeAny, TNoOptional extends boolean = false> = TNoOptional extends true ? TType : TColumn['_']['hasDefault'] extends true ? z.ZodOptional<TType> : TType;
declare type GetZodType<TColumn extends AnyPgColumn> = TColumn['_']['data'] extends infer TType ? TColumn['_']['config'] extends {
    enum: [string, ...string[]];
} ? Or<Equal<[string, ...string[]], TColumn['_']['config']['enum']>, Equal<string[], TColumn['_']['config']['enum']>> extends true ? z.ZodString : z.ZodEnum<TColumn['_']['config']['enum']> : TType extends number ? z.ZodNumber : TType extends string ? z.ZodString : TType extends boolean ? z.ZodBoolean : TType extends Date ? z.ZodDate : z.ZodAny : never;
...
export declare type BuildInsertSchema<TTable extends AnyPgTable, TCase extends 'snake' | 'camel' | undefined, TRefine extends Record<string, z.ZodTypeAny | undefined>, TNoOptional extends boolean = false> = TTable['_']['columns'] extends infer TColumns extends Record<string, AnyPgColumn> ? {
...
export declare type GetRequiredConfigFields<T extends AnyPgTable> = T['_']['columns'] extends infer TColumns extends Record<string, AnyPgColumn> ? {
